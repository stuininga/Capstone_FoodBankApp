                    ...
                    <form role="form" id="addClient" action="<?php echo base_url() ?>addNewClient" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class='form-group'>
                                        <label for="connected" class="no-label"></label>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="connected[]" type="checkbox" id="1" value="1" <?php echo set_checkbox('connected[]', '1', false); ?>>
                                            <label class="form-check-label" for="1">Connected</label>
                                        </div> 
                                    </div>
                                </div>
                            </div><!--End Row-->
